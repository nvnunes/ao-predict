...
# Setup-controlled stats selectors
...
SETUP_STATS_SR_METHODS = (
    STATS_SR_METHOD_PIXEL_FIT,
    STATS_SR_METHOD_PIXEL_MAX,
)
SETUP_STATS_FWHM_SUMMARIES = (
    STATS_FWHM_SUMMARY_GEOM,
    STATS_FWHM_SUMMARY_MEAN,
    STATS_FWHM_SUMMARY_MAX,
    STATS_FWHM_SUMMARY_MIN,
)
DEFAULT_SETUP_SR_METHOD = STATS_SR_METHOD_PIXEL_FIT
DEFAULT_SETUP_FWHM_SUMMARY = STATS_FWHM_SUMMARY_GEOM
