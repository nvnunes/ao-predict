...
KEY_SIMULATION_EXTRA_STAT_NAMES = "extra_stat_names"
...
SIMULATION_KEYS_CORE = (
    ...
    KEY_SIMULATION_EXTRA_STAT_NAMES,
)
...
DEFAULT_SETUP_SR_METHOD = DEFAULT_SR_METHOD
DEFAULT_SETUP_FWHM_SUMMARY = DEFAULT_FWHM_SUMMARY
